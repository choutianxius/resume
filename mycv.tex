...
\section{Experience}
  \subHeadingListStart
    ...
    \itemListStart
      ...
      \mySecondaryItem{
        Developed a cross-platform mobile application with React Native and Expo. Implemented Material Design principles for stying. Built a performant plotting library with React Native Skia and D3.js for customized weather forecast graphs.
      }
      \mySecondaryItem{
    ...
    \twoRowSubHeading
      {Social Network App for Aggies}
      {Texas A\&M Univ.}
      {Java Backend Development | \textit{Spring Boot, Gradle, Redis, MongoDB, Java }}
      {Sept 2023 -- Nov 2023}
    \itemListStart
      \mySecondaryItem{
        Built a Gradle-managed Java backend application for a social network app with the Spring Boot framework.
      }
      \mySecondaryItem{
        Implemented OOP principles and built the app in multiple layers of separated concerns including models, services, DAO and authentication.
      }
      \mySecondaryItem{
        Configured MongoDB and Redis for data persistence and managed database access with Spring Data.
      }
    \itemListEnd
