...
\vspace{3pt}\centerline{
  \faHome\hspace{4pt} 1800 Holleman Drive, College Station, Texas 77840
}
...
\mySecondaryItem{
  Performed data visualization with Plotly and Matplotlib. Implemented a solution to transmit visualized diagrams as HTML content from the server to the frontend to dramatically improve the responsiveness of the frontend app.
}
\mySecondaryItem{
